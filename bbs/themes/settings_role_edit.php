...
echo '<div id="Form" class="Account RoleEditForm">
	...
	if (!$this->Role->Unauthenticated) {
		...
		<li>
			<p class="Description">
				<strong>'.$this->Context->GetDefinition('RoleAbilities').'</strong>'."&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"./\" onclick=\"CheckAll('PERMISSION_'); return false;\">".$this->Context->GetDefinition('All').'</a>&nbsp;&nbsp;&nbsp;'
		...
		if ($this->Role->RoleID == 0 && $this->CategoryData) {
			echo '<li>
				<p class="Description">
					<br /><strong>'.$this->Context->GetDefinition('RoleCategoryNotes').'</strong>'."&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"./\" onclick=\"CheckAll('AllowedCategoryID'); return false;\">".$this->Context->GetDefinition('All').'</a>&nbsp;&nbsp;&nbsp;'
