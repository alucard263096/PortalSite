...
echo '<div id="Form" class="Extensions Applicants">';
	...
	echo '<fieldset>
		...
		<ul>';
			if ($this->Context->Database->RowCount($this->ApplicantData) > 0) {
				echo '<li class="CheckController"><p>'."<a href=\"./\" onclick=\"CheckAll('ApplicantID'); return false;\">".$this->Context->GetDefinition('All').'</a>&nbsp;&nbsp;&nbsp;'
