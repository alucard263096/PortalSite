...
echo '<div class="About">
	'.$this->Context->GetDefinition('AboutMembership').'
			<BR><BR><p><a href="'.GetUrl($this->Context->Configuration, 'index.php').'">'.$this->Context->GetDefinition('BackToMainPage').'</a></p>
		</div>
		<div id="Form" class="ApplyForm">
			...
			echo '<li id="TermsOfServiceCheckBox">
				'.GetBasicCheckBox('AgreeToTerms', 1, 1,'').' '.str_replace('//1', ' <a href="'.$TermsOfServiceUrl.'" onclick="PopTermsOfService('."'".$TermsOfServiceUrl."'".'); return false;">'.$this->Context->GetDefinition('TermsOfService').'</a>', $this->Context->GetDefinition('IHaveReadAndAgreeTo')).'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			</li>
			</ul>
