<?php
// Note: This file is included from the library/Guagua/Guagua.Control.ThemeAndStyle.php control.
...
if (!$this->Context->Session->User->Permission('PERMISSION_MANAGE_THEMES') && !$this->Context->Session->User->Permission('PERMISSION_MANAGE_STYLES')) {
	...
	echo '<div id="Form" class="Account Theme">';
		...
		echo '<fieldset>
			<legend>'.$this->Context->GetDefinition('ManageThemeAndStyle').'</legend>
			'.$this->Get_Warnings().'
