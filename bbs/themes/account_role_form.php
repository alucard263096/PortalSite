<?php
// Note: This file is included from the library/Guagua/Guagua.Control.AccountRoleForm.php class.
	...
	echo '<div id="Form" class="Account Role">
		<fieldset>
			...
			<ul>
				...
				<li>
					<label for="txtNotes">'.$this->Context->GetDefinition('RoleChangeInfo').'</label>
