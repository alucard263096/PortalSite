...
<script id="allmobilize" charset="utf-8" src="<{$rootpath}>/themes/site_themes/ememed/js/allmobilize.min.js"></script>
...
<title>薏米网首页</title>
<link href="<{$rootpath}>/themes/site_themes/ememed/css/common.css" rel="stylesheet" type="text/css" />
<link rel="stylesheet" type="text/css" href="<{$rootpath}>/themes/site_themes/ememed/css/index.css" />
<link rel="stylesheet" type="text/css" href="<{$rootpath}>/themes/site_themes/ememed/css/validate.css" />
<link rel="stylesheet" type="text/css" href="<{$rootpath}>/themes/site_themes/ememed/css/doctor.css" />
<!--[if IE 6]>
<link href="<{$rootpath}>/themes/site_themes/ememed/css/ie6.css" rel="stylesheet" type="text/css" />
<![endif]-->
<script type="text/javascript" src="<{$rootpath}>/themes/site_themes/ememed/js/jquery-1.6.min.js"></script>
<!--[if IE 6]>
<script language="javascript" src="<{$rootpath}>/themes/site_themes/ememed/js/DD_belatedPNG_0.0.8a-min.js"></script>
<script>
    DD_belatedPNG.fix('.fixpng, img');
</script>
<![endif]-->
<script language="javascript" src="<{$rootpath}>/themes/site_themes/ememed/js/jquery.validationEngine-zh_CN.js"></script>
<script language="javascript" src="<{$rootpath}>/themes/site_themes/ememed/js/jquery.validationEngine.js"></script>
<script language="javascript" src="<{$rootpath}>/themes/site_themes/ememed/js/jquery.passwordStrength.js"></script>
<script language="javascript" src="<{$rootpath}>/themes/site_themes/ememed/js/thickbox-compressed.js"></script>
<script language="javascript" src="<{$rootpath}>/themes/site_themes/ememed/js/public.js"></script>
...
function showForm(objstr,s){
	if(objstr=='loginForm'){
		if(s){
			...
			$("#loginHeader").attr('src','<{$rootpath}>/themes/site_themes/ememed/images/web/loginHeader.jpg');
		}else{
			$("#loginform :radio").eq(0).attr('checked','checked');
			$("#loginHeader").attr('src','<{$rootpath}>/themes/site_themes/ememed/images/web/loginHeader2.jpg');
		}
	}
...
<div class="loading absolute nodisplay"><img src="<{$rootpath}>/themes/site_themes/ememed/images/loading1.jpg" /></div>
<!----公共容器----->
<div id="pinfo" class="absolute" style="z-index:8;"></div>
<!----登录背景end----->
<!----登录表单----->
<div class="loginForm absolute nodisplay" style="z-index:8;">
	<div><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/loginHeader.jpg" id="loginHeader" border="0" usemap="#Map" />
      <map name="Map" id="Map">
...
;padding:5px 10px;color:#fff;" tabindex="5">会员注册</a></li>
                ...
                <li class="MT10 size14"><input type="hidden" id="huodong130420content_login" name="huodong130420content_login" value="" />
									<input name="" id="loginbutton" type="image" src="<{$rootpath}>/themes/site_themes/ememed/images/web/btLogin.jpg" tabindex="4" />
				 </li>
            </ul>
        </form>
        </div>
...
<div class="regForm absolute nodisplay" style="z-index:8; width:827px;">
	<div class="bgReg TR">
    	...
    	<ul class="Fright">
        	<li><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/imgRegHeader.jpg" align="top" /><a href="javascript:;" onclick="closeForm('regForm')"><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/cha2.jpg" align="top" style="margin:22px 21px 0px 32px; border:none;" /></a></li>
        </ul>
    </div>
    <div class="BG_e0f2f0">
    	<!----用户注册表单----->
...
<ul class="clear">
            ...
            <ul class="clear">
            	<li class="Fleft TR"><input type="hidden" id="huodong130420content_reg" name="huodong130420content_reg" value="" />&nbsp;</li>
				              <li class="Fleft"><a href="#" onclick="javascript:reg_loginbtn();" ><img name="userlogin_button" id="userlogin_button" src="<{$rootpath}>/themes/site_themes/ememed/images/web/btLogin1.jpg" style="border:none;position:relative;top:15px;top:12px\9;display:none;" /></a> <input name="userreg_submit" id="userreg_submit" type="image" src="<{$rootpath}>/themes/site_themes/ememed/images/web/btReg.jpg" align="absmiddle" class="MR10" style="width:101px;height:37px;border:none;" onclick="submit();return false;" /><span class="color7">*</span>为必填项</li>
			              </ul>
            <ul class="clear"></ul>
        </form>
...
<p>（二）您点击&ldquo;同意&rdquo;键即视为您自愿签署本协议。本协议自您签署之时起生效，有效期至您申请注销或网站注销用户名为止。</p>
		...
		<img src="<{$rootpath}>/themes/site_themes/ememed/images/web/lastest_ad.jpg" /><br />
		...
		话费按职称赠送：主任医师：150元；副主任医师：100元；主治医师：50元，主治级以下：30元。</span>
            ...
            <ul class="clear">
            	<li class="Fleft TR">&nbsp;</li>
				              <li class="Fleft"><input type="image" src="<{$rootpath}>/themes/site_themes/ememed/images/web/btreg.png" align="absmiddle" class="MR10" /><span class="color7">*</span>为必填项</li>
			              </ul>
            <ul class="clear"></ul>
        </form>
...
<div id="smallIndex" style="width:800px;height:600px;background:url('<{$rootpath}>/themes/site_themes/ememed/images/web/800x600/bgLogo.jpg') no-repeat scroll left top #01354B;display:none;">
	<div style="padding:35px 36px 0px 200px;" >
		...
		<!--<span id="current_city1">深圳市</span> [<a href="javascript:show_cities('cities1');">切换城市</a>] -->
				<a href="javascript:;" onclick="showForm('loginForm')" class="color1" style="background-color:#00A04A
;padding:6px 12px;margin-right:10px;">登录</a><a href="javascript:;" onclick="showForm('regForm');showRegForm(1);" class="color1" style="background-color:#DE3347;padding:6px 12px;margin-right:10px;">医生注册</a><a href="javascript:;" onclick="showForm('regForm');showRegForm(0);" class="color1" style="background-color:#00ACE3;padding:6px 12px;margin-right:10px;">会员注册</a><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/photo.jpg" align="absmiddle" class='ML10' />
				</div>
		<div style="margin-top:10px;">热线电话：4009003333</div>
		
		</div>
        <div id="smallIndex" style="padding-top:50px; height:232px;">
        	<div class="absolute"><a href="http://www.ememed.net/find_doctor.html"><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/800x600/menu1.jpg" /></a></div>
            <div class="absolute" style="margin:0px 0px 0px 157px;"><a href="javascript:;" onclick="showpinfo('index_memberspace')"><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/800x600/menu2.jpg" border="0" /></a></div>
            <div class="absolute" style="margin:0px 0px 0px 350px;"><a href="javascript:;" onclick="showpinfo('index_doctorspot')"><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/800x600/menu3.jpg" border="0" /></a></div>
            <div class="absolute" style="margin:80px 0px 0px 0px;"><a href="javascript:;" onclick="showpinfo('index_barleyservice')"><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/800x600/menu4.jpg" border="0" /></a></div>
            <div class="absolute" style="margin:80px 0px 0px 157px;"><a href="javascript:;" onclick="showpinfo('index_mydoctor')"><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/800x600/menu5.jpg" border="0" /></a></div>
            <div class="absolute" style="margin:80px 0px 0px 350px;"><a href="javascript:;" onclick="showpinfo('index_doctorwork')"><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/800x600/menu6.jpg" border="0" /></a></div>
            <div class="absolute" style="margin:160px 0px 0px 0px;"><a href="http://www.ememed.net/news/index.html"><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/800x600/menu7.jpg" /></a></div>
            <div class="absolute" style="margin:160px 0px 0px 77px;"><a href="javascript:;" onclick="showpinfo('index_barleyassistant')"><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/800x600/menu8.jpg" /></a></div>
            <div class="absolute" style="margin:160px 0px 0px 157px;"><a href="http://www.ememed.net/huodong/index.html"><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/800x600/menu_activities.jpg" border="0" /></a></div>
            <!--<div class="absolute" style="margin:160px 0px 0px 350px;"><a href="http://www.ememed.net/huodong/register_invite.html"><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/800x600/menu10.jpg" border="0" /></a></div>-->
        </div>
...
<a href='/profile/certificate.html'>互联网医疗保健信息服务审核同意书【粤卫网审（2012）439号】</a> 粤ICP证【粤B2-20130429】<!--<a href='/profile/certificate1.html'></a>--> 粤ICP备12059183号-1<br />
	...
	<a href="/profile/mobileclient.html" target="_blank"><img src="<{$rootpath}>/themes/site_themes/ememed/images/homedownload.jpg" /></a>
	</span>	
</div>
...
;padding:6px 12px;margin-right:5px;font-size:14px;">登录</a><a href="javascript:;" onclick="showForm('regForm');showRegForm(1);" class="color1" style="background-color:#DE3347;padding:6px 12px;margin-right:5px;font-size:14px;">医生注册</a><a href="javascript:;" onclick="showForm('regForm');showRegForm(0);" class="color1" style="background-color:#00ACE3;padding:6px 12px;margin-right:5px;font-size:14px;">会员注册</a><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/photo.jpg" align="absmiddle" class='ML10' />
        ...
        <div style="padding-top:80px; height:376px;">
        	<div class="absolute"><a href="http://www.ememed.net/find_doctor.html"><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/menu1.jpg" /></a></div>
            <div class="absolute" style="margin:0px 0px 0px 256px;"><a href="javascript:;" onclick="showpinfo('index_memberspace')"><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/menu2.jpg" border="0" /></a></div>
            <div class="absolute" style="margin:0px 0px 0px 553px;"><a href="javascript:;" onclick="showpinfo('index_doctorspot')"><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/menu3.jpg" border="0" /></a></div>
            <div class="absolute" style="margin:128px 0px 0px 0px;"><a href="javascript:;" onclick="showpinfo('index_barleyservice')"><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/menu4.jpg" border="0" /></a></div>
            <div class="absolute" style="margin:128px 0px 0px 256px;"><a href="javascript:;" onclick="showpinfo('index_mydoctor')"><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/menu5.jpg" border="0" /></a></div>
            <div class="absolute" style="margin:128px 0px 0px 553px;"><a href="javascript:;" onclick="showpinfo('index_doctorwork')"><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/menu6.jpg" border="0" /></a></div>
            <div class="absolute" style="margin:256px 0px 0px 0px;"><a href="http://www.ememed.net/news/index.html"><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/menu7.jpg" /></a></div>
            <div class="absolute" style="margin:256px 0px 0px 128px;"><a href="javascript:;" onclick="showpinfo('index_barleyassistant')"><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/menu8.jpg" /></a></div>
            <div class="absolute" style="margin:256px 0px 0px 256px;"><a href="http://www.ememed.net/huodong/index.html"><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/menu_activities.jpg" border="0" /></a></div>
            <!--<div class="absolute" style="margin:256px 0px 0px 553px;"><a href="http://www.ememed.net/huodong/register_invite.html"  ><img src="<{$rootpath}>/themes/site_themes/ememed/images/web/menu10.jpg" border="0" /></a></div>-->
        </div>
